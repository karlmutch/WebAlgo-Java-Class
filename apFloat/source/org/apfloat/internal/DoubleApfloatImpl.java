...
public final class DoubleApfloatImpl
    ...
    implements ApfloatImpl
{
        ...
        throws IOException, NumberFormatException, ApfloatRuntimeException
    {
        ...
        long initialSize = ctx.getMemoryTreshold() / 8,
        ...
        throws ApfloatRuntimeException
    {
        ...
        if (this == that)
        {
            ...
            else
            {
                ...
                double carry = baseAdd(src1, src2, 0, dst, size - 1);
        ...
        throws ApfloatRuntimeException
    {
        ...
        else
        {
            ...
            double carry = baseAdd(src, null, (double) 1, dst, size);     // Add carry
