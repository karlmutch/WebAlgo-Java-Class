...
public class LongTwoPassFNTStrategy
    extends LongParallelFNTStrategy
{
        ...
        throws ApfloatRuntimeException
    {
        ...
        long w = getForwardNthRoot(PRIMITIVE_ROOT[modulus], length),         // Forward n:th root
                w1 = modPow(w, (long) n2);                                   // Forward n1:th root
        long[] wTable = createWTable(w1, n1);
        ...
        if (n1 != n2)
        {
            long w2 = modPow(w, (long) n1);             // Forward n2:th root
        ...
        for (int i = 0; i < n1; i += b)
        {
            ...
            multiplyElements(arrayAccess, i, b, n2, w, (long) 1);
        ...
        throws ApfloatRuntimeException
    {
        ...
        long w = getInverseNthRoot(PRIMITIVE_ROOT[modulus], length),         // Inverse n:th root
                w2 = modPow(w, (long) n1),                                   // Inverse n2:th root
                inverseTotalTransformLength = modDivide((long) 1, (long) totalTransformLength);
        long[] wTable = createWTable(w2, n2);
        int[] permutationTable = Scramble.createScrambleTable(n1);
    ...
    private int getMaxMemoryBlockSize(long length)
    {
        ...
        long maxMemoryBlockSize = Util.round2down(Math.min(ctx.getMaxMemoryBlockSize() / 8, Integer.MAX_VALUE));
