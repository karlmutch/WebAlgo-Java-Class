...
/**
 * Convolution methods in the transform domain for the <code>long</code> type.
...
public class Long3NTTConvolutionStrategy
    extends LongModMath
    implements ConvolutionStrategy
{
    ...
    public Long3NTTConvolutionStrategy(int radix, NTTStrategy transform)
    {
        this.transform = transform;
        this.carryCRT = new LongCarryCRT(radix);
    }
