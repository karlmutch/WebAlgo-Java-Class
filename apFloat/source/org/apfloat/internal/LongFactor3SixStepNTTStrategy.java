    ...
    extends LongParallelFNTStrategy
{
    ...
    private class ColumnTransformRunnable
        implements Runnable
    {
        public ColumnTransformRunnable(boolean isInverse, ArrayAccess arrayAccess0, ArrayAccess arrayAccess1, ArrayAccess arrayAccess2, int startColumn, int columns, long w, long ww, long w1, long w2)
        {
        ...
        public void run()
        {
            ...
            long[] data0 = this.arrayAccess0.getLongData(),
                      data1 = this.arrayAccess1.getLongData(),
                      data2 = this.arrayAccess2.getLongData();
        ...
        throws ApfloatRuntimeException
    {
        ...
        else
        {
            ...
            long w = getForwardNthRoot(PRIMITIVE_ROOT[modulus], length),     // Forward n:th root
                    w3 = modPow(w, (long) power2length);                     // Forward 3rd root
        ...
        throws ApfloatRuntimeException
    {
        ...
        else
        {
            ...
            long w = getInverseNthRoot(PRIMITIVE_ROOT[modulus], length),     // Inverse n:th root
                    w3 = modPow(w, (long) power2length);                     // Inverse 3rd root
    ...
    private void transformColumns(final boolean isInverse, final ArrayAccess arrayAccess0, final ArrayAccess arrayAccess1, final ArrayAccess arrayAccess2, final int size, final long w, final long w3)
        throws ApfloatRuntimeException
    {
        final long ww = modMultiply(w, w),
