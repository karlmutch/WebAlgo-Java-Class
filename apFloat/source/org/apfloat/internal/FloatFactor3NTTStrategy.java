    ...
    implements ParallelNTTStrategy
{
    ...
    public FloatFactor3NTTStrategy(NTTStrategy factor2Strategy)
    {
    ...
    private void transformColumns(boolean isInverse, DataStorage dataStorage0, DataStorage dataStorage1, DataStorage dataStorage2, long size, float w, float w3)
        throws ApfloatRuntimeException
    {
