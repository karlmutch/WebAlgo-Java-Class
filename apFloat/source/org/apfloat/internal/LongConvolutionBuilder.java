...
/**
 * Creates convolutions of suitable type for the specified length for the <code>long</code> type.<p>
 *
 ...
 * @see Long3NTTConvolutionStrategy
 *
 * @version 1.4
    ...
    implements ConvolutionBuilder
{
    ...
    public ConvolutionStrategy createConvolution(int radix, long size1, long size2, long resultSize)
    {
        ...
        else if (minSize <= LongKaratsubaConvolutionStrategy.CUTOFF_POINT)
        {
        ...
        else
        {
            ...
            else
            {
                ...
                return new Long3NTTConvolutionStrategy(radix, transform);
            }
        }
    }
