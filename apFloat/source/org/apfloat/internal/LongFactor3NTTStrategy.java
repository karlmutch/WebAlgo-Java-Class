    ...
    implements ParallelNTTStrategy
{
    ...
    public LongFactor3NTTStrategy(NTTStrategy factor2Strategy)
    {
    ...
    private void transformColumns(boolean isInverse, DataStorage dataStorage0, DataStorage dataStorage1, DataStorage dataStorage2, long size, long w, long w3)
        throws ApfloatRuntimeException
    {
